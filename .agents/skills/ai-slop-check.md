...
3. If unclear, ask the user which project, file, or component.

Read the relevant source. Skim referenced CSS, tokens, and component files so you can resolve actual values.
