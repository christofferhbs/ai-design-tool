...
- If the current project already has an artboard wrapper, render the framed prototype inside a `DCArtboard`.
...
- **A canvas** — multiple variants side-by-side via the project's `DesignCanvas`
