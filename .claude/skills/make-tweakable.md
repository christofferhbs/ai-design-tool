...
This repo already provides `useTweaks` and `TweaksPanel` in `src/tweaks/tweaks-panel.jsx`. Use those helpers instead of reimplementing the protocol. If a new child project does not have them yet, copy the existing project pattern.
