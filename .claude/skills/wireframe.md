...
For a single screen, lay out the variations side-by-side using the project's `DesignCanvas`, `DCSection`, and `DCArtboard` components. For a multi-screen flow, build each variation as a small storyboard (3–5 screens stacked or arranged horizontally).
